-- AI Brain Database Schema (Without pgvector)
-- Complete brain-inspired architecture for persistent AI personality

-- Enable required extensions (vector extension not available)
...
CREATE TABLE episodic_memory (
    ...
    embedding TEXT, -- Changed from VECTOR(1536) to TEXT
    created_at TIMESTAMP DEFAULT NOW()
);
